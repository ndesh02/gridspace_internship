...
9. In addition to what I've learned in school, I've also learned quite a bit over the course of my last three co-ops as well. My first internship at the Engineering Ideas Clinic at the University of Waterloo focused on creating a mini autonomous cart. Over the course of this internship, I learned about Machine Learning and how to create CNNs. My second internship took place at BTNX, where I focused on mobile app and web app development. I used Xamarin to create an app for Android and iOs and I created a secure website from scratch to work alongside the app. During my third internship at Descartes, I focused on Full Stack and Backend development using .Net framework and .Net core. I think my previous internship experience will help make me an asset to Gridspace.
